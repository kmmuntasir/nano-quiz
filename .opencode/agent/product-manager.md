...
1. **Never use the interactive question/ask tool.** All questions are written to a `questions/NN-*.md` file with an answer slot; the user replies in the thread when done.
