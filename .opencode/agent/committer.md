...
1. **Discover the commit-message convention** for this repo at runtime:
   ...
   - This project's convention: `NANO-<id>: <subject>` (e.g. `NANO-123: add per-question timer`). When no ticket id exists, use a conventional type prefix (`feat:`, `fix:`, `docs:`, `chore:`, etc.).
