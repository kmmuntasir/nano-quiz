...
export default function QuestionDisplay({
  ...
  return (
    <section className="flex w-full flex-col gap-4 rounded-lg border border-slate-200 bg-white p-4 md:gap-5 md:p-6 dark:border-slate-800 dark:bg-slate-900">
