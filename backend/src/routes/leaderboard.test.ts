...
describe('GET /api/leaderboard', () => {
    ...
    it('returns users sorted by score DESC', async () => {
        mockedQuery.mockResolvedValueOnce({
            rows: [
                { name: 'Alice', employee_id: 'E1', score: 10, duration_seconds: 300 },
                { name: 'Bob', employee_id: 'E2', score: 8, duration_seconds: 200 },
                { name: 'Charlie', employee_id: 'E3', score: 5, duration_seconds: 150 },
            ],
        } as any)
    ...
    it('breaks ties by duration ASC', async () => {
        mockedQuery.mockResolvedValueOnce({
            rows: [
                { name: 'Fast', employee_id: 'E1', score: 10, duration_seconds: 200 },
                { name: 'Medium', employee_id: 'E2', score: 10, duration_seconds: 300 },
                { name: 'Slow', employee_id: 'E3', score: 10, duration_seconds: 400 },
            ],
        } as any)
    ...
    it('excludes users who have not completed the quiz', async () => {
        mockedQuery.mockResolvedValueOnce({
            rows: [{ name: 'Alice', employee_id: 'E1', score: 10, duration_seconds: 200 }],
        } as any)
    ...
    it('includes rank field starting at 1', async () => {
        mockedQuery.mockResolvedValueOnce({
            rows: [
                { name: 'Alice', employee_id: 'E1', score: 10, duration_seconds: 200 },
                { name: 'Bob', employee_id: 'E2', score: 8, duration_seconds: 300 },
            ],
        } as any)
